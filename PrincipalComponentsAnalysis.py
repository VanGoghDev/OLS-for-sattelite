...
class PCA:
    def __init__(self, result, count, n, isz: ISZ):
        ...
        self.modelPlus = ISZ(0, self.count, 1, n, self.resultChangePlus[0], self.Sputnik)
        self.modelMinus = ISZ(0, self.count, 1, n, self.resultChangeMinus[0], self.Sputnik)

        self.Hm = np.zeros((self.count, n))
